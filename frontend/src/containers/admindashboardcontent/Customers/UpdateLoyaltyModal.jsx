...
const UpdateLoyaltyModal = ({setShowModalLoyaltyUpdate, userId}) => {

  const [loyaltyUpdate, setLoyaltyUpdate] = useState(null);
  ...
  const updateLoyalty = async (e) => {
    ...
    fd.append('loyaltyPoints', loyaltyUpdate);
    ...
    return (
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start text-center justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              ...
              <button
                ...
                onClick={() => setShowModalLoyaltyUpdate(false)}
              >
      ...
      type="text" id="comment" onChange={(e)=> setLoyaltyUpdate(e.target.value)} value={loyaltyUpdate} required />
            </div>
            {/*footer*/}
...
export default UpdateLoyaltyModal;