...
const UpdateOpeningTimeModal = ({setShowModalOpeningTimeUpdate}) => {

  const [openingTimeUpdate, setOpeningTimeUpdate] = useState(null);
  const jwtToken = React.useContext(TokenContext); 
  const updateOpeningTime= async (e) => {

    const fd = new FormData();
    fd.append('hours_open', openingTimeUpdate);
    ...
    return (
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start text-center justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              ...
              <button
                ...
                onClick={() => setShowModalOpeningTimeUpdate(false)}
              >
      ...
      type="text" id="comment" onChange={(e)=> setOpeningTimeUpdate(e.target.value)} value={openingTimeUpdate} required />
            </div>
            {/*footer*/}
...
export default UpdateOpeningTimeModal;