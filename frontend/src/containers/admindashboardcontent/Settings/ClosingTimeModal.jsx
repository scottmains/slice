...
const UpdateClosingTimeModal = ({setShowModalClosingTimeUpdate}) => {
  ...
  const updateClosingTime= async (e) => {
    ...
    fd.append('hours_closed', closingTimeUpdate);
    ...
    return (
          ...
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
            ...
            <div className="flex items-start text-center justify-between p-5 border-b border-solid border-slate-200 rounded-t">
              ...
              <button
                ...
                onClick={() => setShowModalClosingTimeUpdate(false)}
              >
      ...
      type="text" id="comment" onChange={(e)=> setClosingTimeUpdate(e.target.value)} value={closingTimeUpdate} required />
            </div>
            {/*footer*/}
...
export default UpdateClosingTimeModal;